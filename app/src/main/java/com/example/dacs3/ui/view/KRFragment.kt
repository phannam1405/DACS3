...
class KRFragment : Fragment(R.layout.fragment_k_r) {
    private lateinit var lvKrMusic: ListView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lvKrMusic = view.findViewById(R.id.lv_kr_music)
        viewModel = ViewModelProvider(requireActivity()).get(MainViewModel::class.java)

        // Lấy dữ liệu bài hát thể loại Vietnam từ ViewModel
        viewModel.getSongsByCategory("Korean").observe(viewLifecycleOwner, Observer { songList ->
